...
// ********************************************************************
//
// $Id: G4HadronPhysicsINCLXX_BIAS.cc 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsINCLXX_BIAS
//
...
// 01.03.2013 D. Mancusi: Rename to G4HadronPhysicsINCLXX_BIAS and introduce
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsINCLXX_BIAS);

G4ThreadLocal G4HadronPhysicsINCLXX_BIAS::ThreadPrivate*
G4HadronPhysicsINCLXX_BIAS::tpdata = 0;

G4HadronPhysicsINCLXX_BIAS::G4HadronPhysicsINCLXX_BIAS(G4int)
...
G4HadronPhysicsINCLXX_BIAS::G4HadronPhysicsINCLXX_BIAS(const G4String& name, const G4bool quasiElastic, const G4bool neutronHP, const G4bool ftfp)
...
void G4HadronPhysicsINCLXX_BIAS::CreateModels()
{
...
G4HadronPhysicsINCLXX_BIAS::~G4HadronPhysicsINCLXX_BIAS()
{
  if(tpdata) {
...
void G4HadronPhysicsINCLXX_BIAS::ConstructParticle()
{
...
void G4HadronPhysicsINCLXX_BIAS::ConstructProcess()
{
