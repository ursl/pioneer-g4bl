...
// ********************************************************************
//
// $Id: G4HadronPhysicsQGSP_BIC_HIMB_HP.cc 73040 2013-08-15 09:36:57Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsQGSP_BIC_HIMB_HP
//
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQGSP_BIC_HIMB_HP);

G4ThreadLocal G4HadronPhysicsQGSP_BIC_HIMB_HP::ThreadPrivate*
G4HadronPhysicsQGSP_BIC_HIMB_HP::tpdata = 0;

G4HadronPhysicsQGSP_BIC_HIMB_HP::G4HadronPhysicsQGSP_BIC_HIMB_HP(G4int)
...
G4HadronPhysicsQGSP_BIC_HIMB_HP::G4HadronPhysicsQGSP_BIC_HIMB_HP(const G4String& name, G4bool /* quasiElastic */)
...
void G4HadronPhysicsQGSP_BIC_HIMB_HP::CreateModels()
{
...
G4HadronPhysicsQGSP_BIC_HIMB_HP::~G4HadronPhysicsQGSP_BIC_HIMB_HP()
{
...
void G4HadronPhysicsQGSP_BIC_HIMB_HP::ConstructParticle()
{
...
void G4HadronPhysicsQGSP_BIC_HIMB_HP::ConstructProcess()
{
