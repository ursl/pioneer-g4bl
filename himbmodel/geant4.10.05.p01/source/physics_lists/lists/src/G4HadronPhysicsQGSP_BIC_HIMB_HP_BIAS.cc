...
// ********************************************************************
//
// $Id: G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS.cc 73040 2013-08-15 09:36:57Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS
//
...
#include "G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS);

G4ThreadLocal G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::ThreadPrivate*
G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::tpdata = 0;

G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS(G4int)
...
G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS(const G4String& name, G4bool /* quasiElastic */)
...
void G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::CreateModels()
{
  ...
  tpdata->thePro->RegisterMe(tpdata->theHIMBPro=new G4HIMBProtonBuilder);
...
G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::~G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS()
{
...
void G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::ConstructParticle()
{
...
void G4HadronPhysicsQGSP_BIC_HIMB_HP_BIAS::ConstructProcess()
{
