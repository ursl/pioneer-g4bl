...
// ********************************************************************
//
// $Id: G4HadronPhysicsQGSP_BERT_HP_BIAS.cc 82593 2014-06-30 08:53:14Z gcosmo $
//
//---------------------------------------------------------------------------
//
...
#include "G4HadronPhysicsQGSP_BERT_HP_BIAS.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsQGSP_BERT_HP_BIAS);

G4ThreadLocal G4HadronPhysicsQGSP_BERT_HP_BIAS::ThreadPrivate*
G4HadronPhysicsQGSP_BERT_HP_BIAS::tpdata = 0;

G4HadronPhysicsQGSP_BERT_HP_BIAS::G4HadronPhysicsQGSP_BERT_HP_BIAS(G4int)
...
G4HadronPhysicsQGSP_BERT_HP_BIAS::G4HadronPhysicsQGSP_BERT_HP_BIAS(const G4String& name, G4bool /*quasiElastic */ )
...
void G4HadronPhysicsQGSP_BERT_HP_BIAS::CreateModels()
{
...
G4HadronPhysicsQGSP_BERT_HP_BIAS::~G4HadronPhysicsQGSP_BERT_HP_BIAS()
{
  if (!tpdata) return;
...
void G4HadronPhysicsQGSP_BERT_HP_BIAS::ConstructParticle()
{
...
void G4HadronPhysicsQGSP_BERT_HP_BIAS::ConstructProcess()
{
