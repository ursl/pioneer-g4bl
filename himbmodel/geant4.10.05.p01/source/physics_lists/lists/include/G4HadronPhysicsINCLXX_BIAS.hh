...
// ********************************************************************
//
// $Id: G4HadronPhysicsINCLXX_BIAS.hh 66892 2013-01-17 10:57:59Z gunter $
//
//---------------------------------------------------------------------------
//
...
//----------------------------------------------------------------------------
//
#ifndef G4HadronPhysicsINCLXX_BIAS_h
#define G4HadronPhysicsINCLXX_BIAS_h 1
 ...
 */
class G4HadronPhysicsINCLXX_BIAS : public G4VPhysicsConstructor
{
  public: 
    G4HadronPhysicsINCLXX_BIAS(G4int verbose =1);
    G4HadronPhysicsINCLXX_BIAS(const G4String& name, const G4bool quasiElastic=true, const G4bool neutronHP=false, const G4bool ftfp=false);
    virtual ~G4HadronPhysicsINCLXX_BIAS();
