...
////////////////////////////////////////////////////////////////////////
//
// File:        G4CopyPhysicsOrderedFreeVector.cc
// Version:     2.0
// Created:     1996-08-13
...
G4CopyPhysicsOrderedFreeVector::G4CopyPhysicsOrderedFreeVector(G4double *Energies,
                                                       G4double *Values,
                                                       size_t VectorLength)
  : G4PhysicsVector()
{
...
G4CopyPhysicsOrderedFreeVector::G4CopyPhysicsOrderedFreeVector()
  : G4PhysicsVector()
{
  type = T_G4PhysicsOrderedFreeVector;
}
...
void G4CopyPhysicsOrderedFreeVector::InsertValues(G4double energy, G4double value)
{
...
G4double  G4CopyPhysicsOrderedFreeVector::GetLowEdgeEnergy(size_t binNumber) const
{
        return binVector[binNumber];
} 

G4double  G4CopyPhysicsOrderedFreeVector::GetEnergy(G4double aValue)
{
...
size_t G4CopyPhysicsOrderedFreeVector::FindValueBinLocation(G4double aValue)
{
   G4int n1 = 0;
...
G4double G4CopyPhysicsOrderedFreeVector::LinearInterpolationOfEnergy(G4double aValue,
								 size_t theLocBin)
{
...
size_t G4CopyPhysicsOrderedFreeVector::FindBinLocation(G4double theEnergy) const
{
   G4int n1 = 0;
   G4int n2 = numberOfNodes/2;
   G4int n3 = numberOfNodes - 1;
...
G4double  G4CopyPhysicsOrderedFreeVector::CopyFindLinearEnergy(G4double rand) const
{
