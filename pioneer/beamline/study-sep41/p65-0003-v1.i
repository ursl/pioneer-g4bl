...
virtualdetector CALOENTRr radius=200 length=1 color=1,1,0,0.6 material=Vacuum format=rootExtended file=$G4BLOUTPUTDIR/CALOENTR.root
#########################################################################################
...
profile zloop=13000,$posATAR,1 filename=$G4BLOUTPUTDIR/211.prof particle=pi+
profile zloop=13000,$posATAR,1 filename=$G4BLOUTPUTDIR/11.prof  particle=e+
profile zloop=13000,$posATAR,1 filename=$G4BLOUTPUTDIR/13.prof  particle=mu+

#########
beam particle=pi+ nEvents=10000 x=5.0 y=5.0 z=13000.0 P=65.0 sigmaP=0.01 sigmaX=20.0 sigmaY=20.0
beam particle=mu+ nEvents=10000 x=5.0 y=5.0 z=13000.0 P=65.0 sigmaP=0.01 sigmaX=20.0 sigmaY=20.0
beam particle=e+  nEvents=10000 x=5.0 y=5.0 z=13000.0 P=65.0 sigmaP=0.01 sigmaX=20.0 sigmaY=20.0
