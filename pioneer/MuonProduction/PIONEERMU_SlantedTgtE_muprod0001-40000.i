...
######################## Reference Beam ##########################
reference particle=mu+ referenceMomentum=28 beamX=0 beamY=0 beamZ=150 meanXp=-0.0167 meanYp=0
...
################################# Elements Strengths ####################################
param scaleMom=1.0 ## scale magnet currents from 28 MeV/c to X MeV/c
...
#######################################################################################################################
#place AHSW41 z=$posAHSW41 x=0 rotation=Y165 current=AHSW41setPions
