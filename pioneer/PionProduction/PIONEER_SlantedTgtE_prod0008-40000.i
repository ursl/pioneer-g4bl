...
param -unset first=1
param -unset numEvents=300000000
...
virtualdetector DetPiE5 radius=400 length=0.1 require=((PDGid==-11||PDGid==11||PDGid==-13||PDGid==13||PDGid==211||PDGid==-211||PDGid==2212||PDGid==-2212)&&InitKE>2.0) format=rootExtended color=0.5,0.5,0,0.5
