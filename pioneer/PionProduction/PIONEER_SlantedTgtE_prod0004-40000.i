...
virtualdetector DetEMuPiFromTarget radius=300 length=0.1 require=(PDGid==-11||PDGid==11||PDGid==-13||PDGid==13||PDGid==211||PDGid==-211)&&InitKE>2.0 format=rootExtended color=0.5,0.5,0,0.5
