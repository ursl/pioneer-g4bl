physics QGSP_BIC_HIMB_HYBRID_HP_BIAS_EMY 
...
######################## AHSW momentum selection##################
param -unset MOMENTUM=65.

######################## Reference Beam ##########################
reference particle=pi+ referenceMomentum=$MOMENTUM beamX=0 beamY=0 beamZ=150 meanXp=-0.0167 meanYp=0
...
virtualdetector DetPiE5   radius=300 length=0.1 require=(PDGid==-11||PDGid==11||PDGid==-13||PDGid==13||PDGid==211||PDGid==-211||PDGid==2212||PDGid==-2212)&&InitKE>2.0 format=rootExtended color=0.5,0.5,0,0.5
virtualdetector DetTarget radius=300 length=0.1 require=(PDGid==-11||PDGid==11||PDGid==-13||PDGid==13||PDGid==211||PDGid==-211||PDGid==2212||PDGid==-2212)&&InitKE>2.0 format=rootExtended color=0.5,0.5,0,0.5

################################# Elements Strengths #############
param scaleMom=$MOMENTUM/28.0 ## scale magnet currents from 28 MeV/c to X MeV/c
...
param zTarget=($targetZ+$Ravg*sin($targetYRotation*deg))
...
#######################################################################################################################			  
place DetTarget x=0 y=0 z=150 coordinates=global
#######################################################################################################################
