...
profile zloop=$posQSF41,$posATAR,1 filename=$G4BLOUTPUTDIR/$G4BLOUTPUTDIR-profile-0.txt  
profile zloop=$posQSF41,$posATAR,1 filename=$G4BLOUTPUTDIR/$G4BLOUTPUTDIR-profile-13.txt   particle=mu+
profile zloop=$posQSF41,$posATAR,1 filename=$G4BLOUTPUTDIR/$G4BLOUTPUTDIR-profile-211.txt  particle=pi+
profile zloop=$posQSF41,$posATAR,1 filename=$G4BLOUTPUTDIR/$G4BLOUTPUTDIR-profile-11.txt   particle=el+
profile zloop=$posQSF41,$posATAR,1 filename=$G4BLOUTPUTDIR/$G4BLOUTPUTDIR-profile-2212.txt particle=proton
