...
#
# Created: Thu Jun 2 06:25:05 2022
#
# syntax:
# text    textstring
...
title     "pie5"
timestamp "Thu Jun 2 06:25:05 2022"
...
magnet ASC41 299.76 "A" 1 { {scale2 "SCALE:2"} }
magnet SSL41 0 "A" 1
magnet QSB41 101.138 "A" 1
magnet QSB42 -128.565 "A" 1.5
magnet QSB43 40.1765 "A" 1
magnet SEP41 -38.356 "A" 0.5
magnet QSK41 -40.5 "A" 1
magnet QSK42 90 "A" 1
magnet QSK43 -81 "A" 0.5
slit FSH41-L 3.5 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH41-R 3.5 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
