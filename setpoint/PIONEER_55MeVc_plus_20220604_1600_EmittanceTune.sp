...
#
# Created: Sat Jun 4 16:07:16 2022
#
# syntax:
# text    textstring
...
title     "pie5"
timestamp "Sat Jun 4 16:07:16 2022"
...
magnet ASC41 218.76 "A" 1 { {scale2 "SCALE:2"} }
magnet SSL41 0 "A" 1
magnet QSB41 74.1443 "A" 1
magnet QSB42 -94.2512 "A" 1.5
magnet QSB43 29.4535 "A" 1
magnet SEP41 -50.83 "A" 0.5
magnet QSK41 -26.65 "A" 1
magnet QSK42 68.84 "A" 1
magnet QSK43 -56.16 "A" 0.5
slit FSH41-L 16 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH41-R 16 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FS42-L 10 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FS42-R 75 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FS42-V 50 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH43-L 25 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH43-R 5 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
text ""
