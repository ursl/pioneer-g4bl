...
#
# Created: Thu May 26 16:43:44 2022
#
# syntax:
# text    textstring
...
title     "pie5"
timestamp "Thu May 26 16:43:44 2022"
...
magnet HSC44 -45.0146 "A" 0.5 { {scale2 "SCALE:2"} }
magnet QSF48 -119.494 "A" 1 { {scale2 "SCALE:2"} }
magnet AST41 -226.065 "A" 0.5 { {scale2 "SCALE:2"} }
magnet ASC41 264.083 "A" 1 { {scale2 "SCALE:2"} }
magnet SSL41 -4.642 "A" 1
magnet QSB41 87.641 "A" 1
magnet QSB42 -111.408 "A" 1.5
magnet QSB43 34.815 "A" 1
magnet SEP41 0 "A" 0.5
magnet QSK41 38.018 "A" 1
magnet QSK42 -89.7299 "A" 1
magnet QSK43 72.6937 "A" 0.5
slit FSH41-L 20 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH41-R 20 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FS42-L 40 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FS42-R 40 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FS42-V 160 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH43-L 20 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
slit FSH43-R 20 "mm" 0.5 { {desc ""} {ist2 "POSA"} {sol2 "SOL"} {sol2changecmd "MOVE_TO_SOL"} }
text ""
text "SEP41 HV block (be patient....)"
value SEP41VHVP "STA:2" { {desc "HV+ Status OK?"} }
magnet SEP41VHVP 348.15 "" 0.5 { {commandbutton "off"} {desc "HV+ "} {hopr "200.0"} {ist2 "ISTV:2"} {lopr "0.0"} {sol2 "SOLV:2"} {sta2 ""} }
value SEP41VHVP "ISTI:2" { {desc "Actual I+"} }
value SEP41VHVN "STA:2" { {desc "HV+ Status OK?"} }
magnet SEP41VHVN 348.15 "" 0.5 { {commandbutton "off"} {desc "HV+ "} {hopr "200.0"} {ist2 "ISTV:2"} {lopr "0.0"} {sol2 "SOLV:2"} {sta2 ""} }
