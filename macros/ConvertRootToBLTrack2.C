...
void ConvertRootToBLTrack2(std::string fNameList = "files.txt",
                           std::string outDirectory = "/psi/home/langenegger/data/data/pioneer-g4bl/bl2/",
                           std::string vdetName = "DetEMuPiFromTarget" /*DetFSH41*/
                           ) {
  int cut_pdgid = 211;
  ...
  float det_InitPz, det_InitPx, det_InitPy, det_InitX, det_InitY, det_InitZ, det_InitT, det_InitKE;
